...
buildscr = 2 ;версия для сравнения, если меньше чем в adm04.ini - обновляем
downlurl := "https://raw.githubusercontent.com/Cherdak1/Radmir/main/obnova.exe"
downllen := "https://raw.githubusercontent.com/Cherdak1/Radmir/main/adm04.ini"
...
WM_HELP(){
IniRead, vupd, %a_temp%/adm04.ini, UPD, v
IniRead, desupd, %a_temp%/adm04.ini, UPD, des
desupd := Utf8ToAnsi(desupd)
IniRead, updupd, %a_temp%/adm04.ini, UPD, upd
...
if (photo != "1")
{
UrlDownloadToFile, https://raw.githubusercontent.com/Roomiik/ahkmth/main.., %A_AppData%\RTeam\LDAHK\skins\
UrlDownloadToFile, https://raw.githubusercontent.com/Roomiik/ahkmth/main.., %A_AppData%\RTeam\LDAHK\
IniWrite, 1, %A_AppData%\RTeam\LDAHK\info.ini, info, PStatus
}
URLDownloadToFile, %downllen%, %a_temp%/adm04.ini
IniRead, buildupd, %a_temp%/adm04.ini, UPD, build
if buildupd =
{
